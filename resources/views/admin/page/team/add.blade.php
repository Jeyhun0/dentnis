...
<div class="container mt-5">
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{route('createadd')}}" method="POST" enctype="multipart/form-data">
                            ...
                            @foreach(config('app.languages') as $index => $lang)
                                <div class="tab-pane fade {{$loop->first ? 'active show' : ''}}" id="tab-{{$lang}}" role="tabpanel"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Başlıq" name="{{$lang}}[position]"   class="form-control" id="{{$lang}}-title"
